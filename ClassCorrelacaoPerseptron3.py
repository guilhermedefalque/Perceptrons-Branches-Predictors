import numpy as np
class CorrelacaoPerseptron3:
  def __init__(self, caminho):
    self.quantidade_linhas = 8012
    peso_incial = 1  # w1, w2, w3, w4, historico0, historico1, historico2, historico3, w0
    ...
    self.Lista_Predicoes_Predi0 = np.ones((self.quantidade_linhas, 9), dtype=int)
    self.Lista_Predicoes_Predi1 = np.ones((self.quantidade_linhas, 9), dtype=int)
    self.Lista_Predicoes_Predi2 = np.ones((self.quantidade_linhas, 9), dtype=int)
    self.Lista_Predicoes_Predi3 = np.ones((self.quantidade_linhas, 9), dtype=int)
    self.Lista_Predicoes_Predi4 = np.ones((self.quantidade_linhas, 9), dtype=int)
    self.Lista_Predicoes_Predi5 = np.ones((self.quantidade_linhas, 9), dtype=int)
    self.Lista_Predicoes_Predi6 = np.ones((self.quantidade_linhas, 9), dtype=int)
    self.Lista_Predicoes_Predi7 = np.ones((self.quantidade_linhas, 9), dtype=int)
    self.Lista_Predicoes_Predi8 = np.ones((self.quantidade_linhas, 9), dtype=int)
    self.Lista_Predicoes_Predi9 = np.ones((self.quantidade_linhas, 9), dtype=int)
    self.Lista_Predicoes_Predi10 = np.ones((self.quantidade_linhas, 9), dtype=int)
    self.Lista_Predicoes_Predi11 = np.ones((self.quantidade_linhas, 9), dtype=int)
    self.Lista_Predicoes_Predi12 = np.ones((self.quantidade_linhas, 9), dtype=int)
    self.Lista_Predicoes_Predi13 = np.ones((self.quantidade_linhas, 9), dtype=int)
    self.Lista_Predicoes_Predi14 = np.ones((self.quantidade_linhas, 9), dtype=int)
    self.Lista_Predicoes_Predi15 = np.ones((self.quantidade_linhas, 9), dtype=int)

    self.tamTabHistorico = 8
  ...
  def analiseGeral(self, endereco_instrucao, tipo_Instrucao, tomado):
    ...
    if self.previsoes_anteriores[0] == -1 and self.previsoes_anteriores[1] == -1 and self.previsoes_anteriores[
      ...
      quartaUltimaPredicao = self.Lista_Predicoes_Predi0[resto][7]
      terceiraUltimaPredicao = self.Lista_Predicoes_Predi0[resto][6]
      segundaUltimaPredicao = self.Lista_Predicoes_Predi0[resto][5]
      primeiraUltimaPredicao = self.Lista_Predicoes_Predi0[resto][4]
      ...
      w0 = self.Lista_Predicoes_Predi0[resto][8]
      ...
      if previsao_atual == tomado:
        ...
        if (soma < 0):
          soma = soma * -1
        if (soma < self.Alpha):          
          self.Lista_Predicoes_Predi0[resto][8] = self.Lista_Predicoes_Predi0[resto][8] + self.bias * tomado
      ...
      self.Lista_Predicoes_Predi0[resto][7] = terceiraUltimaPredicao
      self.Lista_Predicoes_Predi0[resto][6] = segundaUltimaPredicao
      self.Lista_Predicoes_Predi0[resto][5] = primeiraUltimaPredicao
      self.Lista_Predicoes_Predi0[resto][4] = previsao_atual
    elif self.previsoes_anteriores[0] == -1 and self.previsoes_anteriores[1] == -1 and self.previsoes_anteriores[
      2] == -1 and self.previsoes_anteriores[3] == 1:

      quartaUltimaPredicao = self.Lista_Predicoes_Predi1[resto][7]
      terceiraUltimaPredicao = self.Lista_Predicoes_Predi1[resto][6]
      segundaUltimaPredicao = self.Lista_Predicoes_Predi1[resto][5]
      primeiraUltimaPredicao = self.Lista_Predicoes_Predi1[resto][4]
      ...
      w0 = self.Lista_Predicoes_Predi1[resto][8]
      ...
      if previsao_atual == tomado:
        ...
        if (soma < 0):
          soma = soma * -1
        if (soma < self.Alpha):          
          self.Lista_Predicoes_Predi1[resto][8] = self.Lista_Predicoes_Predi1[resto][8] + self.bias * tomado
      ...
      self.Lista_Predicoes_Predi1[resto][7] = terceiraUltimaPredicao
      self.Lista_Predicoes_Predi1[resto][6] = segundaUltimaPredicao
      self.Lista_Predicoes_Predi1[resto][5] = primeiraUltimaPredicao
      self.Lista_Predicoes_Predi1[resto][4] = previsao_atual
      ...
      w0 = self.Lista_Predicoes_Predi2[resto][8]
      ...
      if previsao_atual == tomado:
        ...
        if (soma < 0):
          soma = soma * -1
        if (soma < self.Alpha):          
          self.Lista_Predicoes_Predi2[resto][8] = self.Lista_Predicoes_Predi2[resto][8] + self.bias * tomado
      ...
      self.Lista_Predicoes_Predi2[resto][7] = terceiraUltimaPredicao
      self.Lista_Predicoes_Predi2[resto][6] = segundaUltimaPredicao
      self.Lista_Predicoes_Predi2[resto][5] = primeiraUltimaPredicao
      self.Lista_Predicoes_Predi2[resto][4] = previsao_atual

    elif self.previsoes_anteriores[0] == -1 and self.previsoes_anteriores[1] == -1 and self.previsoes_anteriores[
      2] == 1 and self.previsoes_anteriores[3] == 1:

      quartaUltimaPredicao = self.Lista_Predicoes_Predi3[resto][7]
      terceiraUltimaPredicao = self.Lista_Predicoes_Predi3[resto][6]
      segundaUltimaPredicao = self.Lista_Predicoes_Predi3[resto][5]
      primeiraUltimaPredicao = self.Lista_Predicoes_Predi3[resto][4]
      ...
      w0 = self.Lista_Predicoes_Predi3[resto][8]
      ...
      if previsao_atual == tomado:
        ...
        if (soma < 0):
          soma = soma * -1
        if (soma < self.Alpha):          
          self.Lista_Predicoes_Predi3[resto][8] = self.Lista_Predicoes_Predi3[resto][8] + self.bias * tomado
      ...
      self.Lista_Predicoes_Predi3[resto][7] = terceiraUltimaPredicao
      self.Lista_Predicoes_Predi3[resto][6] = segundaUltimaPredicao
      self.Lista_Predicoes_Predi3[resto][5] = primeiraUltimaPredicao
      self.Lista_Predicoes_Predi3[resto][4] = previsao_atual

    elif self.previsoes_anteriores[0] == -1 and self.previsoes_anteriores[1] == 1 and self.previsoes_anteriores[
      2] == -1 and self.previsoes_anteriores[3] == -1:

      quartaUltimaPredicao = self.Lista_Predicoes_Predi4[resto][7]
      terceiraUltimaPredicao = self.Lista_Predicoes_Predi4[resto][6]
      segundaUltimaPredicao = self.Lista_Predicoes_Predi4[resto][5]
      primeiraUltimaPredicao = self.Lista_Predicoes_Predi4[resto][4]
      ...
      w0 = self.Lista_Predicoes_Predi4[resto][8]
      ...
      if previsao_atual == tomado:
        ...
        if (soma < 0):
          soma = soma * -1
        if (soma < self.Alpha):          
          self.Lista_Predicoes_Predi4[resto][8] = self.Lista_Predicoes_Predi4[resto][8] + self.bias * tomado
      ...
      self.Lista_Predicoes_Predi4[resto][7] = terceiraUltimaPredicao
      self.Lista_Predicoes_Predi4[resto][6] = segundaUltimaPredicao
      self.Lista_Predicoes_Predi4[resto][5] = primeiraUltimaPredicao
      self.Lista_Predicoes_Predi4[resto][4] = previsao_atual

    elif self.previsoes_anteriores[0] == -1 and self.previsoes_anteriores[1] == 1 and self.previsoes_anteriores[
      2] == -1 and self.previsoes_anteriores[3] == 1:

      quartaUltimaPredicao = self.Lista_Predicoes_Predi5[resto][7]
      terceiraUltimaPredicao = self.Lista_Predicoes_Predi5[resto][6]
      segundaUltimaPredicao = self.Lista_Predicoes_Predi5[resto][5]
      primeiraUltimaPredicao = self.Lista_Predicoes_Predi5[resto][4]
      ...
      w0 = self.Lista_Predicoes_Predi5[resto][8]
      ...
      if previsao_atual == tomado:
        ...
        if (soma < 0):
          soma = soma * -1
        if (soma < self.Alpha):          
          self.Lista_Predicoes_Predi5[resto][8] = self.Lista_Predicoes_Predi5[resto][8] + self.bias * tomado
      ...
      self.Lista_Predicoes_Predi5[resto][7] = terceiraUltimaPredicao
      self.Lista_Predicoes_Predi5[resto][6] = segundaUltimaPredicao
      self.Lista_Predicoes_Predi5[resto][5] = primeiraUltimaPredicao
      self.Lista_Predicoes_Predi5[resto][4] = previsao_atual

    elif self.previsoes_anteriores[0] == -1 and self.previsoes_anteriores[1] == 1 and self.previsoes_anteriores[
      2] == 1 and self.previsoes_anteriores[3] == -1:

      quartaUltimaPredicao = self.Lista_Predicoes_Predi6[resto][7]
      terceiraUltimaPredicao = self.Lista_Predicoes_Predi6[resto][6]
      segundaUltimaPredicao = self.Lista_Predicoes_Predi6[resto][5]
      primeiraUltimaPredicao = self.Lista_Predicoes_Predi6[resto][4]
      ...
      w0 = self.Lista_Predicoes_Predi6[resto][8]
      ...
      if previsao_atual == tomado:
        ...
        if (soma < 0):
          soma = soma * -1
        if (soma < self.Alpha):          
          self.Lista_Predicoes_Predi6[resto][8] = self.Lista_Predicoes_Predi6[resto][8] + self.bias * tomado
      ...
      self.Lista_Predicoes_Predi6[resto][7] = terceiraUltimaPredicao
      self.Lista_Predicoes_Predi6[resto][6] = segundaUltimaPredicao
      self.Lista_Predicoes_Predi6[resto][5] = primeiraUltimaPredicao
      self.Lista_Predicoes_Predi6[resto][4] = previsao_atual

    elif self.previsoes_anteriores[0] == -1 and self.previsoes_anteriores[1] == 1 and self.previsoes_anteriores[
      2] == 1 and self.previsoes_anteriores[3] == 1:

      quartaUltimaPredicao = self.Lista_Predicoes_Predi7[resto][7]
      terceiraUltimaPredicao = self.Lista_Predicoes_Predi7[resto][6]
      segundaUltimaPredicao = self.Lista_Predicoes_Predi7[resto][5]
      primeiraUltimaPredicao = self.Lista_Predicoes_Predi7[resto][4]
      ...
      w0 = self.Lista_Predicoes_Predi7[resto][8]
      ...
      if previsao_atual == tomado:
        ...
        if (soma < 0):
          soma = soma * -1
        if (soma < self.Alpha):          
          self.Lista_Predicoes_Predi7[resto][8] = self.Lista_Predicoes_Predi7[resto][8] + self.bias * tomado
      ...
      self.Lista_Predicoes_Predi7[resto][7] = terceiraUltimaPredicao
      self.Lista_Predicoes_Predi7[resto][6] = segundaUltimaPredicao
      self.Lista_Predicoes_Predi7[resto][5] = primeiraUltimaPredicao
      self.Lista_Predicoes_Predi7[resto][4] = previsao_atual

    elif self.previsoes_anteriores[0] == 1 and self.previsoes_anteriores[1] == -1 and self.previsoes_anteriores[
      2] == -1 and self.previsoes_anteriores[3] == -1:

      quartaUltimaPredicao = self.Lista_Predicoes_Predi8[resto][7]
      terceiraUltimaPredicao = self.Lista_Predicoes_Predi8[resto][6]
      segundaUltimaPredicao = self.Lista_Predicoes_Predi8[resto][5]
      primeiraUltimaPredicao = self.Lista_Predicoes_Predi8[resto][4]
      ...
      w0 = self.Lista_Predicoes_Predi8[resto][8]
      ...
      if previsao_atual == tomado:
        ...
        if (soma < 0):
          soma = soma * -1
        if (soma < self.Alpha):          
          self.Lista_Predicoes_Predi8[resto][8] = self.Lista_Predicoes_Predi8[resto][8] + self.bias * tomado
      ...
      self.Lista_Predicoes_Predi8[resto][7] = terceiraUltimaPredicao
      self.Lista_Predicoes_Predi8[resto][6] = segundaUltimaPredicao
      self.Lista_Predicoes_Predi8[resto][5] = primeiraUltimaPredicao
      self.Lista_Predicoes_Predi8[resto][4] = previsao_atual

    elif self.previsoes_anteriores[0] == 1 and self.previsoes_anteriores[1] == -1 and self.previsoes_anteriores[
      2] == -1 and self.previsoes_anteriores[3] == 1:

      quartaUltimaPredicao = self.Lista_Predicoes_Predi9[resto][7]
      terceiraUltimaPredicao = self.Lista_Predicoes_Predi9[resto][6]
      segundaUltimaPredicao = self.Lista_Predicoes_Predi9[resto][5]
      primeiraUltimaPredicao = self.Lista_Predicoes_Predi9[resto][4]
      ...
      w0 = self.Lista_Predicoes_Predi9[resto][8]
      ...
      if previsao_atual == tomado:
        ...
        if (soma < 0):
          soma = soma * -1
        if (soma < self.Alpha):          
          self.Lista_Predicoes_Predi9[resto][8] = self.Lista_Predicoes_Predi9[resto][8] + self.bias * tomado
      ...
      self.Lista_Predicoes_Predi9[resto][7] = terceiraUltimaPredicao
      self.Lista_Predicoes_Predi9[resto][6] = segundaUltimaPredicao
      self.Lista_Predicoes_Predi9[resto][5] = primeiraUltimaPredicao
      self.Lista_Predicoes_Predi9[resto][4] = previsao_atual

    elif self.previsoes_anteriores[0] == 1 and self.previsoes_anteriores[1] == -1 and self.previsoes_anteriores[
      2] == 1 and self.previsoes_anteriores[3] == -1:

      quartaUltimaPredicao = self.Lista_Predicoes_Predi10[resto][7]
      terceiraUltimaPredicao = self.Lista_Predicoes_Predi10[resto][6]
      segundaUltimaPredicao = self.Lista_Predicoes_Predi10[resto][5]
      primeiraUltimaPredicao = self.Lista_Predicoes_Predi10[resto][4]
      ...
      w0 = self.Lista_Predicoes_Predi10[resto][8]
      ...
      if previsao_atual == tomado:
        ...
        if (soma < 0):
          soma = soma * -1
        if (soma < self.Alpha):          
          self.Lista_Predicoes_Predi10[resto][8] = self.Lista_Predicoes_Predi10[resto][8] + self.bias * tomado
      ...
      self.Lista_Predicoes_Predi10[resto][7] = terceiraUltimaPredicao
      self.Lista_Predicoes_Predi10[resto][6] = segundaUltimaPredicao
      self.Lista_Predicoes_Predi10[resto][5] = primeiraUltimaPredicao
      self.Lista_Predicoes_Predi10[resto][4] = previsao_atual

    elif self.previsoes_anteriores[0] == 1 and self.previsoes_anteriores[1] == -1 and self.previsoes_anteriores[
      2] == 1 and self.previsoes_anteriores[3] == 1:

      quartaUltimaPredicao = self.Lista_Predicoes_Predi11[resto][7]
      terceiraUltimaPredicao = self.Lista_Predicoes_Predi11[resto][6]
      segundaUltimaPredicao = self.Lista_Predicoes_Predi11[resto][5]
      primeiraUltimaPredicao = self.Lista_Predicoes_Predi11[resto][4]
      ...
      w0 = self.Lista_Predicoes_Predi11[resto][8]
      ...
      if previsao_atual == tomado:
        ...
        if (soma < 0):
          soma = soma * -1
        if (soma < self.Alpha):          
          self.Lista_Predicoes_Predi11[resto][8] = self.Lista_Predicoes_Predi11[resto][8] + self.bias * tomado
      ...
      self.Lista_Predicoes_Predi11[resto][7] = terceiraUltimaPredicao
      self.Lista_Predicoes_Predi11[resto][6] = segundaUltimaPredicao
      self.Lista_Predicoes_Predi11[resto][5] = primeiraUltimaPredicao
      self.Lista_Predicoes_Predi11[resto][4] = previsao_atual

    elif self.previsoes_anteriores[0] == 1 and self.previsoes_anteriores[1] == 1 and self.previsoes_anteriores[
      2] == -1 and self.previsoes_anteriores[3] == -1:

      quartaUltimaPredicao = self.Lista_Predicoes_Predi12[resto][7]
      terceiraUltimaPredicao = self.Lista_Predicoes_Predi12[resto][6]
      segundaUltimaPredicao = self.Lista_Predicoes_Predi12[resto][5]
      primeiraUltimaPredicao = self.Lista_Predicoes_Predi12[resto][4]
      ...
      w0 = self.Lista_Predicoes_Predi12[resto][8]
      ...
      if previsao_atual == tomado:
        ...
        if (soma < 0):
          soma = soma * -1
        if (soma < self.Alpha):          
          self.Lista_Predicoes_Predi12[resto][8] = self.Lista_Predicoes_Predi12[resto][8] + self.bias * tomado
      ...
      self.Lista_Predicoes_Predi12[resto][7] = terceiraUltimaPredicao
      self.Lista_Predicoes_Predi12[resto][6] = segundaUltimaPredicao
      self.Lista_Predicoes_Predi12[resto][5] = primeiraUltimaPredicao
      self.Lista_Predicoes_Predi12[resto][4] = previsao_atual

    elif self.previsoes_anteriores[0] == 1 and self.previsoes_anteriores[1] == 1 and self.previsoes_anteriores[
      2] == -1 and self.previsoes_anteriores[3] == 1:

      quartaUltimaPredicao = self.Lista_Predicoes_Predi13[resto][7]
      terceiraUltimaPredicao = self.Lista_Predicoes_Predi13[resto][6]
      segundaUltimaPredicao = self.Lista_Predicoes_Predi13[resto][5]
      primeiraUltimaPredicao = self.Lista_Predicoes_Predi13[resto][4]
      ...
      w0 = self.Lista_Predicoes_Predi13[resto][8]
      ...
      if previsao_atual == tomado:
        ...
        if (soma < 0):
          soma = soma * -1
        if (soma < self.Alpha):          
          self.Lista_Predicoes_Predi13[resto][8] = self.Lista_Predicoes_Predi13[resto][8] + self.bias * tomado
      ...
      self.Lista_Predicoes_Predi13[resto][7] = terceiraUltimaPredicao
      self.Lista_Predicoes_Predi13[resto][6] = segundaUltimaPredicao
      self.Lista_Predicoes_Predi13[resto][5] = primeiraUltimaPredicao
      self.Lista_Predicoes_Predi13[resto][4] = previsao_atual

    elif self.previsoes_anteriores[0] == 1 and self.previsoes_anteriores[1] == 1 and self.previsoes_anteriores[
      2] == 1 and self.previsoes_anteriores[3] == -1:

      quartaUltimaPredicao = self.Lista_Predicoes_Predi14[resto][7]
      terceiraUltimaPredicao = self.Lista_Predicoes_Predi14[resto][6]
      segundaUltimaPredicao = self.Lista_Predicoes_Predi14[resto][5]
      primeiraUltimaPredicao = self.Lista_Predicoes_Predi14[resto][4]
      ...
      w0 = self.Lista_Predicoes_Predi14[resto][8]
      ...
      if previsao_atual == tomado:
        ...
        if (soma < 0):
          soma = soma * -1
        if (soma < self.Alpha):          
          self.Lista_Predicoes_Predi14[resto][8] = self.Lista_Predicoes_Predi14[resto][8] + self.bias * tomado
      ...
      self.Lista_Predicoes_Predi14[resto][7] = terceiraUltimaPredicao
      self.Lista_Predicoes_Predi14[resto][6] = segundaUltimaPredicao
      self.Lista_Predicoes_Predi14[resto][5] = primeiraUltimaPredicao
      self.Lista_Predicoes_Predi14[resto][4] = previsao_atual

    elif self.previsoes_anteriores[0] == 1 and self.previsoes_anteriores[1] == 1 and self.previsoes_anteriores[
      2] == 1 and self.previsoes_anteriores[3] == 1:

      quartaUltimaPredicao = self.Lista_Predicoes_Predi15[resto][7]
      terceiraUltimaPredicao = self.Lista_Predicoes_Predi15[resto][6]
      segundaUltimaPredicao = self.Lista_Predicoes_Predi15[resto][5]
      primeiraUltimaPredicao = self.Lista_Predicoes_Predi15[resto][4]
      ...
      w0 = self.Lista_Predicoes_Predi15[resto][8]
      ...
      if previsao_atual == tomado:
        ...
        if (soma < 0):
          soma = soma * -1
        if (soma < self.Alpha):          
          self.Lista_Predicoes_Predi15[resto][8] = self.Lista_Predicoes_Predi15[resto][8] + self.bias * tomado
      ...
      self.Lista_Predicoes_Predi15[resto][7] = terceiraUltimaPredicao
      self.Lista_Predicoes_Predi15[resto][6] = segundaUltimaPredicao
      self.Lista_Predicoes_Predi15[resto][5] = primeiraUltimaPredicao
      self.Lista_Predicoes_Predi15[resto][4] = previsao_atual
