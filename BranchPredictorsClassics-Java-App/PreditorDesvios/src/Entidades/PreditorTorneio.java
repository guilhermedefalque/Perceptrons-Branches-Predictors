...
public class PreditorTorneio {
    ...
    public void analise(Long enderecoDesvio, boolean tomado, Long enderecoDestino, boolean predicaoAnterior, boolean predicaoAnteriorAnterior, String nomeDesvio) {
        ...
        boolean acertoLocal = preditorDoisBits.analiseLocalPreditorTorneio(enderecoDesvio, tomado);
        ...
        switch (this.preditor) {
            ...
            case 2:
                ...
                preditorDoisBits.analiseLocal(enderecoDesvio, tomado, enderecoDestino, nomeDesvio);
                break;
            case 3:
                if (acertoGlobal == false && acertoLocal == true) {
                    this.preditor = 2;
    ...
    public void setErro() {
        this.erro = preditorDoisBits.getErro();
    }
    ...
    public void setAcerto() {
        this.acerto = preditorDoisBits.getAcerto();
    }
